...
| 连接管理 | 暗黑模式 |
|:---:|:---:|
| ![连接管理](https://github.com/unrealx766/BreezeRESP/blob/screenshots/home.png) | ![暗黑模式](https://github.com/unrealx766/blob/BreezeRESP/screenshots/dark_mode.png) |

| 数据浏览器 | Pipeline 构建器 |
|:---:|:---:|
| ![数据浏览器](https://github.com/unrealx766/BreezeRESP/blob/screenshots/data_browser.png) | ![Pipeline 构建器](https://github.com/unrealx766/BreezeRESP/blob/screenshots/Pipeline.png) |

| 命令沙盒 |
|:---:|
| ![命令沙盒](https://github.com/unrealx766/BreezeRESP/blob/screenshots/shadow.png) |
