...
export const mockSandboxHistory: SandboxHistoryItem[] = [
  { id: "sb-1", command: "SET user:1001:name \"Jane Doe\"", timestamp: Date.now() - 120_000, status: "applied", diffCount: 1 },
  { id: "sb-2", command: "HSET user:1001:profile city \"New York\"", timestamp: Date.now() - 60_000, status: "preview", diffCount: 1 },
  { id: "sb-3", command: "DEL cache:product:detail:1001", timestamp: Date.now() - 30_000, status: "rolled-back", diffCount: 1 },
  { id: "sb-4", command: "LPUSH queue:email:pending \"new_job\"", timestamp: Date.now() - 10_000, status: "preview", diffCount: 2 },
];
